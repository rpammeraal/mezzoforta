...
macx: LIBS += -L/usr/local/lib/ -lportaudio -L/usr/local/lib/ -logg -lvorbis -lvorbisfile -lmad -lid3tag -lFLAC -framework Foundation -framework CoreServices -framework CoreFoundation -framework AudioUnit -framework AudioToolbox -framework CoreAudio
macx: PRE_TARGETDEPS += /usr/local/lib/libportaudio.a /usr/local/lib/libogg.a /usr/local/lib/libvorbis.a /usr/local/lib/libvorbisfile.a /usr/local/lib/libmad.a /usr/local/lib/libid3tag.a  
