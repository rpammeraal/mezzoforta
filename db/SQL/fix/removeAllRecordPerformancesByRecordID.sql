--  /Users/roy/Music/to\ songbase/rips/ripped/Paul\ Simon/Graceland --	NOTES: REMOVES EVERYTHING FROM ONLINE PERFORMANCE UP TO RECORD PERFORMANCE (INCLUDING)
BEGIN;
...
--	*****************************************************************************************************
--	*****************************************************************************************************
--	NOTES: INSPECT CONTENTS OF 'to_delete'. 
--			ONLY record_performance_id AND COLUMNS RIGHT OF record_performance_id SHOULD BE POPULATED.
--			IF NOT, EXTRA DATA MAY BE REMOVED.
--			ALSO: MAKE A FUCKING BACKUP.
--	*****************************************************************************************************
--	*****************************************************************************************************
--	*****************************************************************************************************
